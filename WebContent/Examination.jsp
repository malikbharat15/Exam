...
int iAlottedTime = Integer.parseInt("10");
...
int Elapsed = (int) currentTime-Integer.parseInt("1"); //-- Elapsed duration of the exam in seconds
...
{
    alert("Your exam duration has ended.");
...
<div id="ExamPageQuestionPaper" style="height: 78%; width:99.5%; position: fixed; padding-left: 0px; padding-top: 78px">
    ...
    <a href="ExamInstructions.jsp" style="padding: 6px"><img src ="images/previous-question-btn.png" style="border: 0"/></a>
